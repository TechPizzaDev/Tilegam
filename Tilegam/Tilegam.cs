...
using ImGuiNET;
using Tilegam.Client.Objects;
using Tilegam.Objects;
...
{
    public class Tilegam : Application
    {
        ...
        public Tilegam() : base(preferredBackend: GraphicsBackend.Direct3D11)
        {
            ...
            _sc.ClearColor = RgbaFloat.CornflowerBlue;
