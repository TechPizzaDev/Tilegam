...
namespace Tilegam.Objects
{
        ...
        where TVertex : unmanaged
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public unsafe UnsafeBatchReserve ReserveUnsafe(int indexCount, int vertexCount)
        {
            ...
            return new UnsafeBatchReserve(vertexOffset, indices, vertices);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public unsafe UnsafeBatchReserve ReserveQuadsUnsafe(int quadCount)
        {
            UnsafeBatchReserve reserve = ReserveUnsafe(quadCount * 6, quadCount * 4);
        ...
        public readonly unsafe struct UnsafeBatchReserve
        {
            public readonly uint VertexOffset;
            public readonly uint* Indices;
            public readonly TVertex* Vertices;

            public UnsafeBatchReserve(uint vertexOffset, uint* indices, TVertex* vertices)
            {
